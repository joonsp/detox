...
If you would like to extend the code generation, please make sure to read the [`generation/README.md`](https://github.com/wix/detox/tree/master/generation#generation)